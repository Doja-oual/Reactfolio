...
var error = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `مدخلات غير مقبولة: يفترض إدخال ${issue.expected}، ولكن تم إدخال ${parsedType4(issue.input)}`;
      case "invalid_value":
...
var error2 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Yanlış dəyər: gözlənilən ${issue.expected}, daxil olan ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error3 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Няправільны ўвод: чакаўся ${issue.expected}, атрымана ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error4 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Tipus invàlid: s'esperava ${issue.expected}, s'ha rebut ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error5 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Neplatný vstup: očekáváno ${issue.expected}, obdrženo ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error6 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ungültige Eingabe: erwartet ${issue.expected}, erhalten ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error9 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Entrada inválida: se esperaba ${issue.expected}, recibido ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error10 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `ورودی نامعتبر: می‌بایست ${issue.expected} می‌بود، ${parsedType4(issue.input)} دریافت شد`;
      case "invalid_value":
        if (issue.values.length === 1) {
...
var error11 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Virheellinen tyyppi: odotettiin ${issue.expected}, oli ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error12 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Entrée invalide : ${issue.expected} attendu, ${parsedType4(issue.input)} reçu`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error13 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Entrée invalide : attendu ${issue.expected}, reçu ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error14 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `קלט לא תקין: צריך ${issue.expected}, התקבל ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error15 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Érvénytelen bemenet: a várt érték ${issue.expected}, a kapott érték ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error16 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Input tidak valid: diharapkan ${issue.expected}, diterima ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error17 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Input non valido: atteso ${issue.expected}, ricevuto ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error18 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `無効な入力: ${issue.expected}が期待されましたが、${parsedType4(issue.input)}が入力されました`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error19 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `ទិន្នន័យបញ្ចូលមិនត្រឹមត្រូវ៖ ត្រូវការ ${issue.expected} ប៉ុន្តែទទួលបាន ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error20 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `잘못된 입력: 예상 타입은 ${issue.expected}, 받은 타입은 ${parsedType4(issue.input)}입니다`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error21 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Грешен внес: се очекува ${issue.expected}, примено ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
          return `Invalid input: expected ${stringifyPrimitive(issue.values[0])}`;
...
var error22 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Input tidak sah: dijangka ${issue.expected}, diterima ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error23 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ongeldige invoer: verwacht ${issue.expected}, ontving ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error24 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ugyldig input: forventet ${issue.expected}, fikk ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error25 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Fâsit giren: umulan ${issue.expected}, alınan ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error26 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `ناسم ورودي: باید ${issue.expected} وای, مګر ${parsedType4(issue.input)} ترلاسه شو`;
      case "invalid_value":
        if (issue.values.length === 1) {
...
var error27 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Nieprawidłowe dane wejściowe: oczekiwano ${issue.expected}, otrzymano ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error28 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Tipo inválido: esperado ${issue.expected}, recebido ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error29 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Неверный ввод: ожидалось ${issue.expected}, получено ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error30 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Neveljaven vnos: pričakovano ${issue.expected}, prejeto ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error31 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Ogiltig inmatning: förväntat ${issue.expected}, fick ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error32 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `தவறான உள்ளீடு: எதிர்பார்க்கப்பட்டது ${issue.expected}, பெறப்பட்டது ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error33 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `ประเภทข้อมูลไม่ถูกต้อง: ควรเป็น ${issue.expected} แต่ได้รับ ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error34 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Geçersiz değer: beklenen ${issue.expected}, alınan ${parsedType3(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error35 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Неправильні вхідні дані: очікується ${issue.expected}, отримано ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error36 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `غلط ان پٹ: ${issue.expected} متوقع تھا، ${parsedType4(issue.input)} موصول ہوا`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error37 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `Đầu vào không hợp lệ: mong đợi ${issue.expected}, nhận được ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error38 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `无效输入：期望 ${issue.expected}，实际接收 ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
...
var error39 = () => {
  ...
  return (issue) => {
    switch (issue.code) {
      case "invalid_type":
        return `無效的輸入值：預期為 ${issue.expected}，但收到 ${parsedType4(issue.input)}`;
      case "invalid_value":
        if (issue.values.length === 1)
